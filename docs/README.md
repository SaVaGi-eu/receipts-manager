...
Comprehensive documentation for Receipt Manager.
...
- [Docker Deployment](DOCKER.md) - Running in Docker
- [macOS App](../platforms/macos/README.md) - Building the macOS application
...
- [Jira Board](https://savagi.atlassian.net/jira/software/c/projects/RM/boards/42)
